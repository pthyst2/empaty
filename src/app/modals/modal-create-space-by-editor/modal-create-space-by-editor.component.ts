...
@Component({
  selector: 'modal-create-space-by-editor',
  templateUrl: './modal-create-space-by-editor.component.html',
  styleUrls: ['./modal-create-space-by-editor.component.sass'],
})
export class ModalCreateSpaceByEditorComponent implements OnInit {
  faTimes = faTimes;
  faPencil = faPencil;
